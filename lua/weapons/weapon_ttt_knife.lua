...
function SWEP:PrimaryAttack()
   ...
   local tr = util.TraceHull({start=spos, endpos=sdest, filter = function( ent ) 
				  ...
				  , mask=MASK_SHOT_HULL, mins=kmins, maxs=kmaxs})
...
if CLIENT then
   function SWEP:DrawHUD()
      ...
      if tr.HitNonWorld and IsValid(tr.Entity) and tr.Entity:IsPlayer()
         and tr.Entity:Health() < (self.Primary.Damage + 10) and not(tr.Entity:IsSpec()) then
